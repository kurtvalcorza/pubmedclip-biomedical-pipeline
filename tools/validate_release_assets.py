...
EXPECTED_MODEL_ID = "flaviagiammarino/pubmed-clip-vit-base-patch32"
...
MODEL_LOAD_EXPR = f"{PIPELINE_CLASS}.from_pretrained(weights_dir=WEIGHTS_DIR, progress=print)"
...
EXPECTED_OUTPUTS = (
    "outputs/pubmedclip_biomedical_train.csv",
    "outputs/pubmedclip_biomedical_input_manifest.json",
    "outputs/pubmedclip_biomedical_evaluation_report.json",
    "outputs/pubmedclip_biomedical_shapes.json",
    "outputs/pubmedclip_biomedical_adapter",
    "outputs/pubmedclip_biomedical_result.json",
...
CODE_MARKERS = (
    ...
    "'source_overlap': source_overlap(splits)",
    "classes = class_names(train_records)",
    "write_dataset_csv(train_records, 'outputs/pubmedclip_biomedical_train.csv')",
    ...
    "pipe.save_artifact(artifact_dir, metadata={'tutorial': 'pubmedclip_biomedical', 'data_source': data_source})",
    ...
    "'weight_file': MODEL_FILENAME, 'weight_format': 'safetensors, digest-verified', 'weight_sha256': MODEL_SHA256, 'source_file': SOURCE_FILENAME, 'source_sha256': SOURCE_SHA256, 'pickle_audit_sha256': PICKLE_AUDIT_SHA256",
    "'corpus': {'name': CORPUS_NAME, 'release': CORPUS_RELEASE, 'license': CORPUS_LICENSE, 'url': CORPUS_URL, 'archive_bytes': CORPUS_ARCHIVE_BYTES, 'archive_sha256': CORPUS_ARCHIVE_SHA256, 'pinned_slices': len(SAMPLE_RECORDS)",
    "transformers.__version__",
    "'device': str(pipe.device)",
)
# Profile-specific learner-facing statements.
MARKDOWN_MARKERS = (
    "**Capability:** zero-shot image classification, image/text embeddings, cosine similarity, text-to-image retrieval and bounded supervised fine-tuning of the vision tower's last blocks on a labelled medical-image dataset",
    "**MIT** licence",
    "**not a clinical tool, not validated for diagnosis or triage**",
    "**not calibrated probabilities**",
    "**prompt/label dependent**",
    "**adaptation with labelled images**",
    "**CC BY 4.0**",
    "**text-to-image mAP**",
    "**non-neural baselines**",
    "**majority floor**",
    "**intensity nearest neighbour**",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    58_286_104: "PubMedCLIP fine-tune adapter.safetensors from the tutorial run (35 tensors)",
    605_156_676: "model.safetensors converted from pytorch_model.bin by convert_source (served file)",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "3b689834868221167494cb69f88b798850c37bbf9c79ddfbe4660aa302cf4c36": "upstream flax_model.msgpack at 26c0c67 (not fetched)",
    "5b9f0ba08490293d6c17b9cef219991e1a6edda31609429679f8dca1af5a7b10": "pickle-audit digest of the pytorch_model.bin global set",
    "81de21a0f1b6a3faaf1ea9e8fed4d570c671808ad72c948b4dac173eabcf676e": "model.safetensors converted from pytorch_model.bin by convert_source (served file)",
    "a19bae532ac0cf979f7474aba7eb923dc9bbf67c1bcba3cb941dce51a59951e9": "organamnist_224.npz, Zenodo record 10519652 (MedMNIST v3.0)",
    "fe5013d5a012ced66ce5c5536177a3467ce0319b00e15b373d0f084173e89f44": "upstream tf_model.h5 at 26c0c67 (not fetched)",
}
